...
def test_panda_robot_wrapper(fixed_base):
    ...
    cfg_settings["scene"] = "/home/vishal/Volume_E/Active/Undergrad_research/Harish_Y/Project_delan/Initial_work/Habitat/habitat-sim/data/scene_datasets/habitat-test-scenes/van-gogh-room.glb"# "NONE"
    ...
    with habitat_sim.Simulator(hab_cfg) as sim:
        ...
        sim.agents[0].scene_node.translation = [1.8, -1.0, 2.0]# [0.0, -1.0, 2.0]
        ...
        panda.reconfigure()
        import magnum as mn
        panda.base_pos = mn.Vector3(1.8, 0, 0.7)
