...
def test_fetch_robot_wrapper(fixed_base):
    ...
    with habitat_sim.Simulator(hab_cfg) as sim:
        ...
        robot_path = "/home/vishal/Volume_E/Active/Undergrad_research/Harish_Y/Project_delan/Initial_work/Habitat/habitat-sim/Vishal_custom_tests/data/robots/hab_fetch.urdf"# "/home/vishal/Volume_E/Active/Undergrad_research/Harish_Y/Project_delan/Initial_work/Habitat/habitat-sim/Vishal_custom_tests/data/robots/fixed_base_test.urdf" # "data/robots/hab_fetch/robots/hab_fetch.urdf"
        ...
        if produce_debug_video:
            ...
            vut.make_video(
                ...
                "color_sensor",
                "color",
                "/home/vishal/Volume_E/Active/Undergrad_research/Harish_Y/Project_delan/Initial_work/Habitat/habitat-sim/Vishal_custom_tests/videos/test_fetch_robot_wrapper4__fixed_base=" + str(fixed_base),
                open_vid=True,
            )

test_fetch_robot_wrapper(True)